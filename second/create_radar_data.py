...
def nuscenes_data_prep(root_path, version, dataset_name, max_sweeps=10):
    ...
    home_path = Path('/home/spalab/jskim/second.pytorch/second/dataset')
    modality = 'radar'
    radar_version = 'versionx3'
    ...
    if version == "v1.0-test":
        name = "infos_test.pkl"
    database_save_path = home_path / f'gt_database_multisweep_{radar_version}_sweep{max_sweeps}'
    db_info_save_path = home_path / f"kitti_dbinfos_multisweep_{radar_version}__sweep{max_sweeps}_train.pkl"
